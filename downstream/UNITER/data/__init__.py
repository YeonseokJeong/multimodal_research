...
from .pretrain_vcr import (MlmDatasetForVCR, MrfrDatasetForVCR, MrcDatasetForVCR, DcDatasetForVCR, MlmDatasetForVCRDC,
                    mlm_collate_for_vcr,   mrfr_collate_for_vcr,  mrc_collate_for_vcr, dc_collate_for_vcr, mlm_collate_for_vcr_dc)

...
from model.make_conf_prior import UniterForConfPriorForVCR, UniterForEmbedConfPriorForVCR,UniterForUpDownConfPriorForVCR
...
def main(opts):
    ...
    # Prepare model
    model = UniterForUpDownConfPriorForVCR.from_pretrained(
